// Source: https://github.com/philburk/android-midisuite/blob/master/MidiTools/src/main/java/com/mobileer/miditools/MidiConstants.java
...
public class MidiConstants {
    protected final static String TAG = "MidiConstants";
